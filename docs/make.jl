...
DocMeta.setdocmeta!(OCPPClient, :DocTestSetup, :(using OCPPClient); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/JuliaSolarPV/OCPPClient.jl/blob/{commit}{path}#{line}",
    sitename = "OCPPClient.jl",
    format = Documenter.HTML(; canonical = "https://JuliaSolarPV.github.io/OCPPClient.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/JuliaSolarPV/OCPPClient.jl")
